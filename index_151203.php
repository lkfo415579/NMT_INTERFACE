...
<!-- ben testing environment -->
			document.write("\<script language=\"javascript\" type=\"text/javascript\" src=\"js/translate151203.js?"+number+"\"><\/script\>"); 
		</script>
	</head>
	<body>
		<!-- Logo Container --> 
...
<span id="ben-input" style="color:red">input</span>
<span id="ben-output" style="color:blue">output</span>
<span id="ben-json">json</span>
				...
				<p align="center">
					Copyright©&nbsp;&nbsp;2012-2015 <a href="http://nlp2ct.cis.umac.mo/">NLP<sup>2</sup>CT Lab</a><br />Natural Language Processing &amp; Portuguese-Chinese Machine Translation Laboratory
